...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/cld_devcloud_iiedmulti_dev_sentinel.inc')) {
  require $_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/cld_devcloud_iiedmulti_dev_sentinel.inc';
}
// </DDSETTINGS>

if (file_exists('/var/www/site-php')) {
    require('/var/www/site-php/iiedmulti/sentinel-settings.inc');
}