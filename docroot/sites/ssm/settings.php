...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/cld_devcloud_iiedmulti_dev_ssm.inc')) {
  require $_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/cld_devcloud_iiedmulti_dev_ssm.inc';
}
// </DDSETTINGS>

if (file_exists('/var/www/site-php/iiedmulti/ssm-settings.inc')) {
    require('/var/www/site-php/iiedmulti/ssm-settings.inc');
}
